...
*/
	...
	rQueryLTEChn.rLteSafeChnList.au4SafeChannelBitmask[NL80211_TESTMODE_AVAILABLE_CHAN_5G_BASE_149-1]=0xFFFFFFFF;

	rQueryLTEChn.rLteSafeChnList.au4SafeChannelBitmask[NL80211_TESTMODE_AVAILABLE_CHAN_5G_BASE_184-1]=0xFFFFFFFF;
    rStatus = kalIoctl(prGlueInfo,
...
//2015.03.03 real-wifi@lge.com[wo0gi] MTK Patch : Modify Hotspot AutoChannelSelect Channel Range(1~14->1~11) [START]
#if 0
            ...
            aucChannelList);
#endif
//2015.03.03 real-wifi@lge.com[wo0gi] MTK Patch : Modify Hotspot AutoChannelSelect Channel Range(1~14->1~11) [END]
