...
extern int get_ustop_state();

static u8 filter_coef_6M[7][16] = {
        { 0x00, 0x00, 0x00, 0x07, 0x0f, 0x01, 0x03, 0x04, 0x01, 0x19, 0x14, 0x18, 0x0a, 0x26, 0x40, 0x4a}, //xtal_in : 24,16,32        (adc clk = 4.0000)
        { 0x00, 0x07, 0x07, 0x00, 0x01, 0x03, 0x03, 0x01, 0x1c, 0x17, 0x16, 0x1e, 0x10, 0x27, 0x3b, 0x43}, //xtal_in : 26              (adc clk = 4.3333)
        { 0x00, 0x07, 0x07, 0x00, 0x01, 0x03, 0x03, 0x00, 0x1b, 0x16, 0x16, 0x1f, 0x11, 0x27, 0x3a, 0x41}, //xtal_in : 27,18           (adc clk = 4.5000)
        { 0x00, 0x00, 0x07, 0x07, 0x00, 0x02, 0x03, 0x03, 0x1f, 0x18, 0x14, 0x1a, 0x0c, 0x26, 0x3e, 0x47}, //xtal_in : 16.384, 24.576  (adc clk = 4.0960)
        { 0x00, 0x07, 0x07, 0x00, 0x02, 0x03, 0x02, 0x0f, 0x1a, 0x16, 0x18, 0x02, 0x13, 0x27, 0x38, 0x3e}, //xtal_in : 19.2, 38.4      (adc clk = 4.8000)
        { 0x00, 0x07, 0x07, 0x00, 0x01, 0x03, 0x03, 0x00, 0x1b, 0x16, 0x16, 0x1f, 0x11, 0x27, 0x3a, 0x41}, //xtal_in : 27.12           (adc clk = 4.5200)
        { 0x00, 0x07, 0x07, 0x00, 0x02, 0x03, 0x03, 0x00, 0x1a, 0x16, 0x17, 0x01, 0x12, 0x27, 0x39, 0x3f}  //xtal_in : 37.4            (adc clk = 4.6750)
};
#if 0
static u8 filter_coef_7M[7][16] = {
        { 0x00, 0x00, 0x00, 0x00, 0x0f, 0x0e, 0x00, 0x04, 0x05, 0x1f, 0x15, 0x12, 0x01, 0x22, 0x45, 0x55}, //xtal_in : 24,16,32        (adc clk = 4.0000)
        { 0x00, 0x00, 0x00, 0x07, 0x0e, 0x0f, 0x02, 0x05, 0x04, 0x1c, 0x14, 0x14, 0x05, 0x24, 0x43, 0x50}, //xtal_in : 26              (adc clk = 4.3333)
        { 0x00, 0x00, 0x00, 0x07, 0x0f, 0x00, 0x03, 0x05, 0x02, 0x1b, 0x14, 0x16, 0x07, 0x25, 0x42, 0x4d}, //xtal_in : 27,18           (adc clk = 4.5000)
        { 0x00, 0x00, 0x00, 0x00, 0x0f, 0x0f, 0x01, 0x04, 0x05, 0x1e, 0x15, 0x13, 0x02, 0x23, 0x44, 0x53}, //xtal_in : 16.384, 24.576  (adc clk = 4.0960)
        { 0x00, 0x00, 0x07, 0x07, 0x00, 0x02, 0x04, 0x03, 0x1f, 0x18, 0x14, 0x1a, 0x0c, 0x26, 0x3e, 0x47}, //xtal_in : 19.2, 38.4      (adc clk = 4.8000)
        { 0x00, 0x00, 0x00, 0x07, 0x0f, 0x00, 0x03, 0x05, 0x02, 0x1b, 0x14, 0x16, 0x07, 0x25, 0x41, 0x4d}, //xtal_in : 27.12           (adc clk = 4.5200)
        { 0x00, 0x00, 0x00, 0x07, 0x0f, 0x01, 0x03, 0x04, 0x00, 0x19, 0x14, 0x18, 0x0a, 0x26, 0x3f, 0x4a}  //xtal_in : 37.4            (adc clk = 4.6750)
};

static u8 filter_coef_8M[7][16] = {
        { 0x00, 0x00, 0x00, 0x01, 0x01, 0x0f, 0x0d, 0x0f, 0x05, 0x06, 0x1d, 0x10, 0xf6, 0x1a, 0x4b, 0x62}, //xtal_in : 24,16,32        (adc clk = 4.0000)
        { 0x00, 0x00, 0x00, 0x01, 0x00, 0x0e, 0x0e, 0x02, 0x06, 0x04, 0x19, 0x10, 0xfb, 0x1e, 0x48, 0x5b}, //xtal_in : 26              (adc clk = 4.3333)
        { 0x00, 0x00, 0x00, 0x00, 0x0f, 0x0e, 0x00, 0x03, 0x05, 0x00, 0x16, 0x11, 0xff, 0x21, 0x46, 0x56}, //xtal_in : 27,18           (adc clk = 4.5000)
        { 0x00, 0x00, 0x00, 0x01, 0x00, 0x0f, 0x0d, 0x00, 0x05, 0x06, 0x1c, 0x10, 0xf7, 0x1b, 0x4a, 0x60}, //xtal_in : 16.384, 24.576  (adc clk = 4.0960)
        { 0x00, 0x00, 0x00, 0x07, 0x0e, 0x0f, 0x01, 0x05, 0x04, 0x1d, 0x14, 0x13, 0x04, 0x23, 0x44, 0x51}, //xtal_in : 19.2, 38.4      (adc clk = 4.8000)
        { 0x00, 0x00, 0x00, 0x00, 0x0f, 0x0e, 0x00, 0x04, 0x05, 0x00, 0x16, 0x12, 0x00, 0x21, 0x46, 0x56}, //xtal_in : 27.12           (adc clk = 4.5200)
        { 0x00, 0x00, 0x00, 0x00, 0x0f, 0x0f, 0x01, 0x04, 0x05, 0x1e, 0x15, 0x13, 0x02, 0x23, 0x44, 0x53}  //xtal_in : 37.4            (adc clk = 4.6750)
};
#endif
...
static void fc8150_clock_mode(HANDLE hDevice)
{
    ...
    else if (bbm_xtal_freq == 26000)
    {
        ...
        PRINTF(hDevice, "fc8150_clock_mode xtal : %d \n", bbm_xtal_freq);
...
int fc8150_probe(HANDLE hDevice)
{
    ...
    PRINTF(NULL, "[1seg][MTK]PROBE : 0x%x \n", ver);
...
int fc8150_init(HANDLE hDevice)
{
    ...
    bbm_write(hDevice, BBM_INT_POLAR_SEL, 0x01);
...
int fc8150_scan_status(HANDLE hDevice)
{
    ...
    for(i = 0; i < ifagc_timeout; i++) {
        ...
        PRINTF(NULL, "[1seg][MTK]ifagc_timeout : 0x%x i : %d\n", data, i);

        if(data & 0x01)
            break;

        msWait(10);
	   if (get_ustop_state() == TRUE)
       {
	        return BBM_NOK;
       }
    }
    ...
    if(rssi < -107){
        PRINTF(NULL, "[1seg][MTK]rssi : 0x%x \n", rssi);
        return BBM_NOK;
        }
    for(; i < ofdm_timeout; i++) {
        bbm_read(hDevice, 0x3025, &data);
        PRINTF(NULL, "[1seg][MTK]ofdm_timeout : 0x%x i : %d\n", data, i);
    ...
    for(; i < ffs_lock_timeout; i++) {
        ...
        PRINTF(NULL, "[1seg][MTK]ffs_lock_timeout : 0x%x i : %d\n", data, i);
    ...
    for(i = 0; i < dagc_timeout; i++) {
        bbm_read(hDevice, 0x3026, &data);
        PRINTF(NULL, "[1seg][MTK]dagc_timeout : 0x%x i : %d\n", data, i);
    ...
    for(i = 0; i < cfs_timeout; i++) {
        ...
        PRINTF(NULL, "[1seg][MTK]cfs_timeout : 0x%x i : %d\n", data, i);
    ...
    for(i = 0; i <     tmcc_timeout; i++) {
        bbm_read(hDevice, 0x3026, &data);
        PRINTF(NULL, "[1seg][MTK]tmcc_timeout : 0x%x i : %d\n", data, i);
        if(data & 0x02)
            break;
    ...
    for(i = 0; i < ts_err_free_timeout; i++) {
        ...
        PRINTF(NULL, "[1seg][MTK]ts_err_free_timeout : 0x%x i : %d\n", data, i);
        if(data & 0x01)
            break;
