							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			 ...
			 *pFeatureParaLen=4;
			break;
		//[LGE_UPDATE_S][yonghwan.lym@lge.com][2014-12-15] Get FOV from sensor for CTS
		case SENSOR_FEATURE_GET_SENSOR_VIEWANGLE:
			{
				...
				//*pHorFOV = (0x3C)<<16 | (0x2F); // 16:9 = 60, 4:3 = 47 // (60)<<16 | (47) ...KK
				*pHorFOV = (0x42)<<16 | (0x35); // 16:9 = 66, 4:3 = 53 // (66)<<16 | (53)   ...LOS
				*pVerFOV = (0x28)<<16 | (0x28); // 16:9 = 40, 4:3 = 40 // (40)<<16 | (40)
				*pFeatureParaLen = 8;
				break;
			}
		//[LGE_UPDATE_E][yonghwan.lym@lge.com][2014-12-15] Get FOV from sensor for CTS
		default:
			break;
	}
