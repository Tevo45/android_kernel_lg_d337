...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("DW9718AF", 0x18)};  //LGE_UPDATE [youmi.jun@lge.com] 2014/12/23, apply mt6582 dw9718af

// [LGE_UPDATE_S][youmi.jun@lge.com][2015/1/12] Remove af i2c error during booting
#if defined(TARGET_MT6732_C90)
extern int af_current_on;
#endif
// [LGE_UPDATE_E][youmi.jun@lge.com][2015/1/12] Remove af i2c error during booting
...
#define DW9718AFDB printk  //LGE_UPDATE [youmi.jun@lge.com] 2014/12/23, apply mt6582 dw9718af
#else
#define DW9718AFDB(x, ...)
#endif

static spinlock_t g_DW9718AF_SpinLock;
//LGE_UPDATE_S [youmi.jun@lge.com] 2014/12/23, apply mt6582 dw9718af
static struct i2c_client *g_pstDW9718AF_I2Cclient = NULL;

static dev_t g_DW9718AF_devno;
static struct cdev *g_pDW9718AF_CharDrv = NULL;
static struct class *actuator_class = NULL;

static int  g_s4DW9718AF_Opened = 0;
static long g_i4MotorStatus = 0;
static long g_i4Dir = 0;
static unsigned long g_u4DW9718AF_INF = 0;
static unsigned long g_u4DW9718AF_MACRO = 1023;
static unsigned long g_u4TargetPosition = 0;
static unsigned long g_u4CurrPosition   = 0;
//LGE_UPDATE_E [youmi.jun@lge.com] 2014/12/23, apply mt6582 dw9718af
...
static int s4DW9718AF_WriteReg(u16 a_u2Data)
{
	...
	udelay(30); //LGE_UPDATE [youmi.jun@lge.com] 2014/12/23, apply mt6582 dw9718af
	if (i4RetValue < 0) {
...
{
//LGE_UPDATE_S [youmi.jun@lge.com] 2015/1/27, change setting because previous setting affects resolution
	long i4RetValue = 0;
	char puSendCmd2[2] = {0x01,0x03}; //0x3F
	char puSendCmd3[2] = {0x05,0xB7}; //0x0C
//LGE_UPDATE_E [youmi.jun@lge.com] 2015/1/27, change setting because previous setting affects resolution
...
//LGE_UPDATE_E [youmi.jun@lge.com] 2015/1/12, remove af i2c error during booting
	...
	if (g_s4DW9718AF_Opened) {
		...
		g_sr = 5;
//LGE_UPDATE_S [youmi.jun@lge.com] 2015/1/27, add steps to reduce tick noise
		...
		msleep(5);
//LGE_UPDATE_E [youmi.jun@lge.com] 2015/1/27, add steps to reduce tick noise
		spin_lock(&g_DW9718AF_SpinLock);
