...
int dw9718_af_current_on; //[LGE_UPDATE] [yonghwan.lym@lge.com] [2015-01-13] L80 Booting I2C Error Delete
...
#endif
            dw9718_af_current_on=1; //[LGE_UPDATE] [yonghwan.lym@lge.com] [2015-01-13] L80 Booting I2C Error Delete
            //if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_2800,mode_name))
            //{
            //    PK_DBG("[CAMERA SENSOR] Fail to enable analog power\n");
            //    //return -EIO;
